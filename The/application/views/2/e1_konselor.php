		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					...
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('2/C_konselor/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_konselor/hapus_konselor/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('2/C_konselor/tambah_baru_konselor'); ?>" method="POST">
