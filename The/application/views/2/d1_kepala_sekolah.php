<h3><b>Daftar Kepala Sekolah</b></h3>
<a href="#" class="btn btn-success btn-sm" data-target="#modal_tambah_data" data-toggle="modal">Tambah Data Kepala Sekolah</a>
</br></br>
	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					<a class="btn btn-success btn-xs" href="#edit_data_kepala_sekolah" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('2/C_sekolah/hapus_admin_sekolah/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_kepala_sekolah/hapus_kepala_sekolah/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_admin_sekolah('C_kepala_sekolah/verifikasi_kepala_sekolah/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_kepala_sekolah" data-toggle="modal" data-id="<?php echo $as->m_user_id;;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_kepala_sekolah/hapus_kepala_sekolah/'); echo $as->m_user_id; ?>');">Hapus</a>
...
<!-- Edit Data Sekolah -->
<div class="modal fade" id="edit_data_kepala_sekolah" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('2/C_kepala_sekolah/tambah_baru_kepala_sekolah'); ?>" method="POST">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_kepala_sekolah').on('show.bs.modal', function (e) {
            var idx = $(e.relatedTarget).data('id');
      
            //menggunakan fungsi ajax untuk pengambilan data
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('2/C_kepala_sekolah/edit_kepala_sekolah/');?>'+ idx,
