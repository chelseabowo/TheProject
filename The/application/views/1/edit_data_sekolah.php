...
<div class="form-group has-feedback">
   <input name="in_sekolah_id" type="hidden" class="form-control" placeholder="Nama Sekolah" value="<?php echo $edit['d_sekolah_id'] ?>">
...
<div class="form-group has-feedback">
  <input name="in_update_by" type="hidden" class="form-control" value="<?php echo $itsme['m_user_id']; ?>" disabled>
</div>
