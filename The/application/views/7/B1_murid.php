<h3><b>Daftar murid</b></h3>
<a href="#" class="btn btn-success btn-sm" data-target="#modal_tambah_data" data-toggle="modal">Tambah murid</a>
</br></br>
	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					<a class="btn btn-success btn-xs" href="#edit_data_murid" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('7/C_murid_verif/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('7/C_murid_verif/hapus_murid/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_murid('C_murid_verif/verifikasi_murid/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_murid" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('7/C_murid_verif/hapus_murid/'); echo $as->m_user_id; ?>');">Hapus</a>
...
<!-- Edit Data Sekolah -->
<div class="modal fade" id="edit_data_murid" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modal_verifikasi_murid">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
        <a href="#" class="btn btn-danger" id="delete_link_verif_murid">Ya</a>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('7/C_murid_verif/tambah_baru_murid'); ?>" method="POST">
...
<!-- JS Show/Hide Password -->
<script type="text/javascript">
    function confirm_verifikasi_murid(delete_url)
    {
      $('#modal_verifikasi_murid').modal('show', {backdrop: 'static'});
      document.getElementById('delete_link_verif_murid').setAttribute('href' , delete_url);
    }
</script>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_murid').on('show.bs.modal', function (e) {
            var idx = $(e.relatedTarget).data('id');
      
            //menggunakan fungsi ajax untuk pengambilan data
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('7/C_murid_verif/edit_murid/');?>'+ idx,
                success : function(data){
                $('.hasil-data8').html(data);//menampilkan data ke dalam modal
                }
            });
         });
    });
