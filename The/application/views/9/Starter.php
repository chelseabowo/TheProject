...
<body>
<form method="POST" action="<?php echo base_url('9/C_starter/update_registrasi'); ?>" name="sekolah">
<div class="container" style="margin-top: 50px;">
    ...
    <div id="app">
        ...
        <div v-show="currentstep == 1">
            <h3>Step 1 : Data Siswa/Siswi</h3>
            <div class="form-group">
                <label for="sekolah">Nomor Induk Siswa</label>
                <input type="text" name="in_siswa" class="form-control" placeholder="Nomor Induk Siswa" onFocus="findstart_siswa();" onBlur="findstop_siswa();" required>
                <input type="hidden" name="in_id_siswa" class="form-control" placeholder="NIS" readonly>
...
<!-- Find ID Siswa -->
<script> 
function findstart_siswa(){
interval = setInterval("find_s()",1);}
function find_s(){
var in_s = document.sekolah.in_siswa.value;
var hasil_s = in_s.split(" ").join("");

document.sekolah.in_id_siswa.value = hasil_s.toUpperCase();
}
function findstop_siswa(){
