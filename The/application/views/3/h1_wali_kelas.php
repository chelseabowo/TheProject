<h3><b>Daftar Wali Kelas</b></h3>
<a href="#" class="btn btn-success btn-sm" data-target="#modal_tambah_data" data-toggle="modal">Tambah Wali Kelas</a>
</br></br>
	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					<a class="btn btn-success btn-xs" href="#edit_data_wali_kelas" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('3/C_wali_kelas/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_wali_kelas('<?php echo base_url ('3/C_wali_kelas/hapus_wali_kelas/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_data_wali_kelas('C_wali_kelas/verifikasi_wali_kelas/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_wali_kelas" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_wali_kelas('<?php echo base_url ('3/C_wali_kelas/hapus_wali_kelas/'); echo $as->m_user_id; ?>');">Hapus</a>
...
<!-- Edit Data Sekolah -->
<div class="modal fade" id="edit_data_wali_kelas" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modal_verifikasi_data_wali_kelas">
...
<div class="modal fade" id="modal_hapus_data_wali_kelas">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('3/C_wali_kelas/tambah_baru_wali_kelas'); ?>" method="POST">
...
<!-- Hapus Data Sekolah -->
<script type="text/javascript">
    function confirm_hapus_data_wali_kelas(delete_url)
    {
      $('#modal_hapus_data_wali_kelas').modal('show', {backdrop: 'static'});
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_wali_kelas').on('show.bs.modal', function (e) {
            var idx = $(e.relatedTarget).data('id');
      
            //menggunakan fungsi ajax untuk pengambilan data
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('3/C_wali_kelas/edit_wali_kelas/');?>'+ idx,
...
<!-- verifikasi Data  -->
<script type="text/javascript">
    function confirm_verifikasi_data_wali_kelas(delete_url)
    {
      $('#modal_verifikasi_data_wali_kelas').modal('show', {backdrop: 'static'});
