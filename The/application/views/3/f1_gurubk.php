		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					...
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('3/C_gurubk/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_gurubk('<?php echo base_url ('3/C_gurubk/hapus_gurubk/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_data_gurubk('C_gurubk/verifikasi_gurubk/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_gurubk" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_gurubk('<?php echo base_url ('3/C_gurubk/hapus_gurubk/'); echo $as->m_user_id; ?>');">Hapus</a>
