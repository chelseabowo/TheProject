<h3><b>Daftar Guru Mapel</b></h3>
<a href="#" class="btn btn-success btn-sm" data-target="#modal_tambah_data" data-toggle="modal">Tambah Guru Mapel</a>
</br></br>
	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					<a class="btn btn-success btn-xs" href="#edit_data_guru_mapel" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('3/C_guru_mapel/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_guru_mapel('<?php echo base_url ('3/C_guru_mapel/hapus_guru_mapel/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_data_guru_mapel('C_guru_mapel/verifikasi_guru_mapel/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_guru_mapel" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_guru_mapel('<?php echo base_url ('3/C_guru_mapel/hapus_guru_mapel/'); echo $as->m_user_id; ?>');">Hapus</a>
...
<!-- Edit Data Sekolah -->
<div class="modal fade" id="edit_data_guru_mapel" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modal_verifikasi_data_guru_mapel">
...
<div class="modal fade" id="modal_hapus_data_guru_mapel">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Guru Mapel</h4>
      </div>

      <div class="modal-body">
         <form action="<?php echo base_url('3/C_guru_mapel/tambah_baru_guru_mapel'); ?>" method="POST">
...
<!-- Hapus Data Sekolah -->
<script type="text/javascript">
    function confirm_hapus_data_guru_mapel(delete_url)
    {
      $('#modal_hapus_data_guru_mapel').modal('show', {backdrop: 'static'});
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_guru_mapel').on('show.bs.modal', function (e) {
            var idx = $(e.relatedTarget).data('id');
      
            //menggunakan fungsi ajax untuk pengambilan data
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('3/C_guru_mapel/edit_guru_mapel/');?>'+ idx,
                success : function(data){
                $('.hasil-data5').html(data);//menampilkan data ke dalam modal
                }
            });
         });
    });
...
<!-- verifikasi Data  -->
<script type="text/javascript">
    function confirm_verifikasi_data_guru_mapel(delete_url)
    {
      $('#modal_verifikasi_data_guru_mapel').modal('show', {backdrop: 'static'});
