...
<div class="modal fade" id="modal_verifikasi_data_kepala_sekolah">
...
<div class="modal fade" id="modal_hapus_data_kepala_sekolah">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('4/C_kepala_sekolah/tambah_baru_kepala_sekolah'); ?>" method="POST">
...
<!-- Hapus Data Sekolah -->
<script type="text/javascript">
    function confirm_hapus_data_kepala_sekolah(delete_url)
    {
      $('#modal_hapus_data_kepala_sekolah').modal('show', {backdrop: 'static'});
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_kepala_sekolah').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('4/C_kepala_sekolah/edit_kepala_sekolah/');?>'+ idx,
...
<!-- verifikasi Data  -->
<script type="text/javascript">
    function confirm_verifikasi_data_kepala_sekolah(delete_url)
    {
      $('#modal_verifikasi_data_kepala_sekolah').modal('show', {backdrop: 'static'});
