    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a href="<?php echo base_url('9/C_dashboard') ?>">
                ...
                <!-- <li class="sub-menu">
                  ...
                  <ul class="sub">
                    <li><a href="">Profil Wali Murid</a></li>
                  </ul>
                </li> -->
                <li class="sub-menu">
                    <a>
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo base_url('9/C_wali_kelas'); ?>">Wali Kelas</a></li>
                        <li><a href="<?php echo base_url('9/C_murid'); ?>">Murid</a></li>
                        <li><a href="<?php echo base_url('9/C_wali_murid'); ?>">Wali Murid</a></li>
                    </ul>
                </li>
            </ul>            
    </div>
