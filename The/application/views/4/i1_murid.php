	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<!-- 		<td>
				...
				?>
					...
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('3/C_murid/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<!-- <a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_murid('<?php echo base_url ('3/C_murid/hapus_murid/'); echo $as->m_user_id; ?>');">Hapus</a> -->
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_data_murid('C_murid/verifikasi_murid/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_murid" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<!-- <a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_data_murid('<?php echo base_url ('3/C_murid/hapus_murid/'); echo $as->m_user_id; ?>');">Hapus</a> -->
...
<div class="modal fade" id="modal_verifikasi_data_murid">
...
<div class="modal fade" id="modal_hapus_data_murid">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('3/C_murid/tambah_baru_murid'); ?>" method="POST">
...
<!-- Hapus Data Sekolah -->
<script type="text/javascript">
    function confirm_hapus_data_murid(delete_url)
    {
      $('#modal_hapus_data_murid').modal('show', {backdrop: 'static'});
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_murid').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('3/C_murid/edit_murid/');?>'+ idx,
...
<!-- verifikasi Data  -->
<script type="text/javascript">
    function confirm_verifikasi_data_murid(delete_url)
    {
      $('#modal_verifikasi_data_murid').modal('show', {backdrop: 'static'});
