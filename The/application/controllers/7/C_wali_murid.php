...
class C_wali_murid extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('7/M_wali_murid');
	...
	public function index()
	{
		...
		$data['a_s'] = $this->M_wali_murid->tampil_murid($data['itsme'])->result();
		$data['content'] ="7/C7_wali_murid";
	...
	function edit_wali_murid($m_user_id){
		...
		$this->load->view('7/edit_data_wali_murid',$data);
	}
