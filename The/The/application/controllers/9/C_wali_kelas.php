...
class C_wali_kelas extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('9/M_wali_kelas');
	...
	public function index()
	{
		...
		$data['content'] ="9/B1_wali_kelas";
		$this->load->view('Home_wali_murid',$data);
	}
	...
	// 	$this->load->view('2/edit_data_wali_kelas',$data);
	// }
