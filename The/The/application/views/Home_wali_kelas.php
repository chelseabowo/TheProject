    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a href="<?php echo base_url('7/C_dashboard') ?>"><i class="fa fa-dashboard"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sub-menu">
                  ...
                  <ul class="sub">
                    <li><a href="<?php echo base_url('7/C_murid_verif'); ?>">Murid</a></li>
                    <li><a href="<?php echo base_url('7/C_wali_murid_verif'); ?>">Wali Murid</a></li>
                  </ul>
                </li>
                <li class="sub-menu">
                    <a>
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo base_url('7/C_kepala_sekolah'); ?>">Kepala Sekolah</a></li>
                        <li><a href="<?php echo base_url('7/C_konselor'); ?>">Konselor</a></li>
                        <li><a href="<?php echo base_url('7/C_gurubk'); ?>">Guru BK</a></li>
                        <li><a href="<?php echo base_url('7/C_guru_mapel'); ?>">Guru Mapel</a></li>
                        <li><a href="<?php echo base_url('7/C_wali_kelas'); ?>">Wali Kelas</a></li>
                        <li><a href="<?php echo base_url('7/C_murid'); ?>">Murid</a></li>
                        <li><a href="<?php echo base_url('7/C_wali_murid'); ?>">Wali_murid</a></li>
                    </ul>
                </li>
            </ul>            
    </div>
