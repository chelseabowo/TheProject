    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a href="<?php echo base_url('5/C_dashboard') ?>">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                       <!--  <li><a href="#">Kepala Sekolah</a></li> -->
                        <li><a href="<?php echo base_url('5/C_kepala_sekolah'); ?>">Kepala Sekolah</a></li>
                        <li><a href="<?php echo base_url('5/C_konselor'); ?>">Konselor</a></li>
                        <li><a href="<?php echo base_url('5/C_gurubk'); ?>">Guru BK</a></li>
                        <li><a href="<?php echo base_url('5/C_guru_mapel'); ?>">Guru Mapel</a></li>
                        <li><a href="<?php echo base_url('5/C_wali_kelas'); ?>">Wali Kelas</a></li>
                        <li><a href="<?php echo base_url('5/C_murid'); ?>">Murid</a></li>
                        <li><a href="<?php echo base_url('5/C_wali_murid'); ?>">Wali Murid</a></li>
                    </ul>
                </li>
            </ul>            
    </div>
