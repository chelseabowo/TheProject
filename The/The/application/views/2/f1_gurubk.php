...
<a href="#" class="btn btn-success btn-sm" data-target="#modal_tambah_data" data-toggle="modal">Tambah Guru BK</a>
</br></br>
	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					<a class="btn btn-success btn-xs" href="#edit_data_gurubk" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('2/C_gurubk/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_gurubk/hapus_gurubk/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
					<a class="btn btn-info btn-xs" href="#" onclick="confirm_verifikasi_admin_sekolah('C_gurubk/verifikasi_gurubk/<?php echo $as->d_user_role_id; ?>');">Verifikasi</a>
					&nbsp;
					<a class="btn btn-success btn-xs" href="#edit_data_gurubk" data-toggle="modal" data-id="<?php echo $as->m_user_id;?>">Edit</a>
					&nbsp;
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_gurubk/hapus_gurubk/'); echo $as->m_user_id; ?>');">Hapus</a>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('2/C_gurubk/tambah_baru_gurubk'); ?>" method="POST">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_gurubk').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('2/C_gurubk/edit_gurubk/');?>'+ idx,
