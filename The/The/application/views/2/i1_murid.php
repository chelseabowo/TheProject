		...
		<tbody>
			...
			<tr style="background-color:#F7FFE6;">
				...
				?>
					...
					&nbsp;<!-- 
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('2/C_murid/hapus_koselor/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('2/C_murid/hapus_murid/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('2/C_murid/tambah_baru_murid'); ?>" method="POST">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_murid').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('2/C_murid/edit_murid/');?>'+ idx,
