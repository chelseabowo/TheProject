	...
	<table id="myTable" class='table table-bordered' syle="color:#CDF76F">
		...
		<tbody>
          ...
          <a class="btn btn-danger btn-xs" href="#" onclick="confirm_modal('<?php echo base_url('1/C_sekolah/hapus_admin_sekolah/'); echo $ls->d_sekolah_id; ?>');">Hapus</a> -->
					<a class="btn btn-danger btn-xs" href="#" onclick="confirm_hapus_admin_sekolah('<?php echo base_url ('1/C_kepala_sekolah/hapus_kepala_sekolah/'); echo $as->m_user_id; ?>');">Hapus</a>
				<?php	
				}else{
				?>
...
<div id="modal_tambah_data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form action="<?php echo base_url('1/C_kepala_sekolah/tambah_baru_kepala_sekolah'); ?>" method="POST">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#edit_data_kepala_sekolah').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url  : '<?php echo base_url('1/C_kepala_sekolah/edit_kepala_sekolah/');?>'+ idx,
